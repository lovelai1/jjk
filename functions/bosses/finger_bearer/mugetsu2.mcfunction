...
execute as @s[scores={Deleter=3..}] at @s run damage @e[tag=!Frames,r=3,type=!ds:finger_bearer] 8 suicide
execute as @s[scores={Deleter=3..}] at @s run scoreboard players set @e[tag=!Frames,r=3,type=!ds:finger_bearer] Stun 25
execute as @s[scores={Deleter=3..}] at @s run scoreboard players set @e[tag=!Frames,r=3,type=!ds:finger_bearer] Hit 4
execute as @s[scores={Deleter=3..}] at @s run scoreboard players add @e[tag=!Frames,r=3,type=!ds:finger_bearer] Evade 7
