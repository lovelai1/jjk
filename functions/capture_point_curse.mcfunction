...
execute unless entity @a[tag=capture_point,tag=curse,r=16] unless entity @e[family=sorcerer,r=16,type=!ds:capture_point] run particle ds:capture_point1
execute if entity @a[tag=capture_point,tag=curse,r=16] unless entity @e[family=sorcerer,r=16,type=!ds:capture_point] run particle ds:capture_point1b
execute if entity @e[family=sorcerer,r=16,type=!ds:capture_point] run particle ds:capture_point1c


execute if entity @a[tag=capture_point,tag=curse,r=16] unless entity @e[family=sorcerer,r=16,type=!ds:capture_point] run scoreboard players add @s Mode 1
execute if entity @e[family=sorcerer,r=16,type=!ds:capture_point] run scoreboard players remove @s[scores={Mode=1..}] Mode 1
...
execute as @s[scores={scroll=210..}] at @s run function capture_point_curse_random_spawn
