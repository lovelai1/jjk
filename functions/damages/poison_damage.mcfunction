...
tag @e[family=mahoraga,r=15,tag=!poison_adapted] add poison_adapting
...
tag @e[scores={wheelactive=1..,adaptCD=0},r=15,tag=!poison_adapted,rm=0.25] add poison_adapting
