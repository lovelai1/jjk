...
tag @e[family=mahoraga,r=15,tag=!speech_adapted] add speech_adapting
...
tag @e[scores={wheelactive=1..,adaptCD=0},r=15,tag=!speech_adapted,rm=0.25] add speech_adapting

effect @e[scores={wheelactive=1..},r=15,tag=speech_adapted,rm=0.25] instant_health 1 0 true
