...
scoreboard players set @s[tag=heavenlyrestriction,scores={agility=25..},type=player] flashstep 9
...
scoreboard players set @s[family=heavenlyrestriction,type=!player] flashstep 9
...
playanimation @s animation.dash_right
