...
execute as @s[scores={move=25}] at @s positioned ^^^13 run scoreboard players add @e[r=12.99,tag=!Frames] Stun 30
execute as @s[scores={move=25}] at @s positioned ^^^13 run scoreboard players add @e[r=12.99,tag=!Frames] Evade 29
execute as @s[scores={move=25}] at @s positioned ^^^13 run scoreboard players add @e[r=12.99,tag=!Frames] Hit 12
execute as @s[scores={move=25}] at @s positioned ^^^13 run damage @e[r=12.99,tag=!Frames] 25 entity_attack entity @s
...
execute as @s[scores={move=25}] at @s if entity @e[tag=griefable,c=1]  run effect @e[r=25] resistance 1 10 true
