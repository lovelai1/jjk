...
playanimation @s[scores={domainstart=100}] animation.jogo_domain
execute as @s[scores={domainstart=100}] at @s run playsound mob.jogodomain @a ~~~ 100000 0.975 100000
...
tag @s[scores={domainstart=1..2},tag=form7] remove form7
...
execute as @s[scores={domainstart=1..50}] at @s if entity @e[type=!item,tag=domainlayout,r=48,rm=0.5] run playanimation @s animation.jogo_domain_hold
...
execute as @s[scores={domainstart=46}] at @s unless entity @e[type=!item,tag=domainlayout,r=48,rm=0.5] run scoreboard players set @e[r=48,type=!item,family=!projectile,family=!despawncito,family=!damage,type=!xp_orb,type=!arrow,type=!falling_block,type=!ds:lapse_explode,type=!ds:red_reversal,type=!ds:hollow_nuke,type=!ds:limitless_explosion,type=!ds:pressure,type=!ds:energy_explosion,type=!ds:massive_bomb,type=!ds:shrine_dmg,type=!ds:pachinko_impact1,type=!ds:bolt_explode,type=!ds:shikigami_impact,type=!ds:oxrushex,type=!gg:impact_frame,type=!armor_stand,scores={domainstart=2..}] domainstart 1
execute as @s[scores={domainstart=46},tag=form7] at @s unless entity @e[type=!item,tag=domainlayout,r=48,rm=0.5] run tag @s remove form7
