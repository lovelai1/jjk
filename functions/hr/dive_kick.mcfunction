...
tag @s[scores={move=20..,Stun=1..},tag=wep2] remove wep2
...
execute as @s[scores={move=5..19}] at @s if block ~~-0.5~ air if block ~~-1~ air run tp @s ~~~~ 0
execute as @s[scores={move=5..19}] at @s run tp @s ^^-0.25^0.25
execute as @s[scores={move=5..19}] at @s if block ~~-0.5~ air if block ~~-1~ air if block ^^-0.5^0.5 air if block ^^-1^1 air run tp @s ^^-1^1
execute as @s[scores={move=5..19}] at @s if block ~~-0.5~ air if block ~~-1~ air if block ^^-0.5^0.5 air if block ^^-1^1 air run tp @s ^^-1^1
...
execute as @s[scores={move=5..19}] at @s if block ~~-0.5~ air if block ~~-1~ air run tp @e[tag=!Frames,r=5,type=!item,family=!projectile,family=!despawncito,family=!damage,type=!xp_orb,type=!arrow,type=!falling_block,tag=!unselect,type=!ds:lapse_explode,type=!ds:red_reversal,type=!ds:hollow_nuke,type=!ds:limitless_explosion,type=!ds:pressure,type=!ds:energy_explosion,type=!ds:massive_bomb,type=!ds:shrine_dmg,type=!ds:pachinko_impact1,type=!ds:bolt_explode,type=!ds:shikigami_impact,type=!ds:oxrushex,type=!gg:impact_frame,type=!armor_stand] ~~~ facing @s


execute as @s[scores={move=5..19}] at @s unless block ^^-0.5^0.5 air run scoreboard players set @s move 4
...
execute as @s[scores={move=3,strength=1..25}] at @s  run damage @e[tag=!Frames,r=6,type=!item,family=!projectile,family=!despawncito,family=!damage,type=!xp_orb,type=!arrow,type=!falling_block,tag=!unselect,type=!ds:lapse_explode,type=!ds:red_reversal,type=!ds:hollow_nuke,type=!ds:limitless_explosion,type=!ds:pressure,type=!ds:energy_explosion,type=!ds:massive_bomb,type=!ds:shrine_dmg,type=!ds:pachinko_impact1,type=!ds:bolt_explode,type=!ds:shikigami_impact,type=!ds:oxrushex,type=!gg:impact_frame,type=!armor_stand] 16 suicide entity @s
...
execute as @s[scores={move=3,strength=25..}] at @s  run damage @e[tag=!Frames,r=8,type=!item,family=!projectile,family=!despawncito,family=!damage,type=!xp_orb,type=!arrow,type=!falling_block,tag=!unselect,type=!ds:lapse_explode,type=!ds:red_reversal,type=!ds:hollow_nuke,type=!ds:limitless_explosion,type=!ds:pressure,type=!ds:energy_explosion,type=!ds:massive_bomb,type=!ds:shrine_dmg,type=!ds:pachinko_impact1,type=!ds:bolt_explode,type=!ds:shikigami_impact,type=!ds:oxrushex,type=!gg:impact_frame,type=!armor_stand] 24 suicide entity @s
