...
execute as @s[scores={move=11}] at @s run summon ds:knife ^2^1^3 facing ^^^9
execute as @s[scores={move=11}] at @s run summon ds:knife ^1^1^3 facing ^^^9
execute as @s[scores={move=11}] at @s run summon ds:knife ^^1^3 facing ^^^9
execute as @s[scores={move=11}] at @s run summon ds:knife ^-1^1^3 facing ^^^9
execute as @s[scores={move=11}] at @s run summon ds:knife ^-2^1^3 facing ^^^9
