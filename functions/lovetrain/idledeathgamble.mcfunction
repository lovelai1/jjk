...
playanimation @s[scores={domainstart=100..}] animation.hakari_domain
execute as @s[scores={domainstart=95}] at @s run playsound mob.deathgamble1 @a ~~~ 100000 1 100000
execute as @s[scores={domainstart=95}] at @s run playsound mob.wither.shoot @a ~~~ 100000 0.15 100000
execute as @s[scores={domainstart=85}] at @s run playsound mob.wither.shoot @a ~~~ 100000 0.25 100000
...
tag @e[type=!item,scores={domainstart=1..2},tag=form5] remove form5
...
execute as @s[scores={domainstart=1..50}] at @s if entity @e[type=!item,tag=domainlayout,r=48,rm=0.5] run scoreboard players set @s domainstart 40
execute as @s[scores={domainstart=41..50}] at @s unless entity @e[type=!item,tag=domainlayout,r=48,rm=0.5] run scoreboard players set @s domainstart 40
...
execute as @s[scores={domainstart=1..50}] at @s if entity @e[type=!item,tag=domainlayout,r=48,rm=0.5] run playanimation @s animation.hakari_domain_standby
...
execute as @s[scores={domainstart=38}] at @s unless entity @e[type=!item,tag=domainlayout,r=48,rm=0.5] run scoreboard players set @s domain 441 
execute as @s[scores={domainstart=38}] at @s unless entity @e[type=!item,tag=domainlayout,r=48,rm=0.5] run scoreboard players set @e[r=48] domainstart 1
