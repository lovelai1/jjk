...
tag @s remove rolledtraits
tag @s remove rollingtraits
tag @s remove rolledtrait
tag @s remove rollingtrait
tag @s remove selectedtrait1
tag @s remove selectedtrait2
tag @s remove selectedtrait3
scoreboard players set @s traitrolls 0
