...
execute unless score mobeventstoggle Mode = three Mode as @p[r=50] run structure load inumakis ~~~
...
execute as @s if entity @p[tag=high_sorcerer_quest,c=1,tag=curse,m=!spectator] run function missions/credit/killcredit_grade1sorcerer
