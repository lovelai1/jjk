...
execute as @s[type=ds:kusakabe,scores={Disabled=0,move=0,cutscene=0,combat=1..},tag=!hit] at @s if entity @e[tag=!Frames,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,type=!ds:kusakabe,r=7.5,c=1] run scoreboard players random @s chance 3 19

execute as @s[type=ds:kusakabe,scores={Disabled=0,move=0,cutscene=0,combat=1..},tag=!hit] at @s unless entity @e[tag=!Frames,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,type=!ds:kusakabe,r=7.5,c=1] if entity @e[tag=!Frames,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,type=!ds:kusakabe,r=40,c=1] run scoreboard players random @s chance 20 30

tag @s[tag=hit] remove hit
execute as @s[scores={hitCD=0,Stun=0,Disabled=6..,move=0,cutscene=0,chance=0,combat=1..}] if entity @e[type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,type=!ds:kusakabe,r=2.25,c=1] run scoreboard players random @s chance 1 2
execute as @s[scores={hitCD=0,Stun=0,Disabled=6..,move=0,cutscene=0,combat=1..}] if entity @e[type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,type=!ds:kusakabe,r=2.25,c=1] run tag @s add hit
...
scoreboard players set @s[scores={combat=0,detect_health=0..220}] rct 5
scoreboard players set @s[scores={detect_health=0..50,rct=0}] rct 60
...
scoreboard players set @s[scores={chance=30,Stun=0,move=0,ability2=0}] move 101
scoreboard players set @s[scores={chance=30,Stun=0,move=1..}] Disabled 55
scoreboard players set @s[scores={chance=30,Stun=0,move=1..}] ability2 1200
execute as @s[scores={chance=30,move=1..}] at @s run function fighting/shadow_style_katana/hazy_moon
