...
execute as @p[r=60]  unless entity @e[type=ds:rift,r=100] run summon ds:rift "dukerift" ~~5~
execute as @p[r=60] run fill ~10~10~10~-10~-10~-10 stone [] replace repeating_command_block
