execute as @s[type=ds:reality_shard] unless entity @p[scores={kaiguydeath=1..}] run event entity @s ds:disappear
...
execute as @s[type=ds:reality_shard] run give @p[r=2] ds:reality_shard1
