...
execute as @s[scores={chance=1,move=6}] at @s positioned ^^^1.85 run damage @e[tag=!Frames,r=1.8,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,family=!shikigami,family=!shadows,tag=!Big] 6 suicide entity @s
...
execute as @s[scores={chance=1,move=6}] at @s positioned ^^^4.85 run damage @e[tag=!Frames,r=4.8,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,family=!shikigami,family=!shadows,tag=Big] 7 suicide entity @s
...
execute as @s[scores={chance=1,move=6}] at @s positioned ^^^4.85 run damage @e[type=!item,tag=!Frames,r=4.849,family=purecurse] 15 suicide
execute as @s[scores={chance=2,move=16}] at @s positioned ^^^4.85 run damage @e[type=!item,tag=!Frames,r=4.849,family=purecurse] 11 suicide
...
execute as @s[scores={chance=2,move=16}] at @s positioned ^^^1.85 run damage @e[tag=!Frames,r=1.8,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,family=!shikigami,family=!shadows,tag=!Big] 6 suicide entity @s
...
execute as @s[scores={chance=2,move=16}] at @s positioned ^^^4.85 run damage @e[tag=!Frames,r=4.8,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,family=!shikigami,family=!shadows,tag=Big] 6 suicide entity @s
...
execute as @s[scores={chance=2,move=10}] at @s positioned ^^^1.85 run damage @e[tag=!Frames,r=1.8,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,family=!shikigami,family=!shadows,tag=!Big] 6 suicide entity @s
...
execute as @s[scores={chance=2,move=10}] at @s positioned ^^^4.85 run damage @e[tag=!Frames,r=4.8,type=!item,type=!xp_orb,family=!damage,family=!projectile,type=!ds:projectile,type=!arrow,family=!despawncito,tag=!unselect,type=!armor_stand,family=!shikigami,family=!shadows,tag=Big] 6 suicide entity @s
