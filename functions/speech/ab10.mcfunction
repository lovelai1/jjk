...
playanimation @s[scores={move=70..71},tag=!megaphone] animation.cursed_speech.die
playanimation @s[scores={move=70..71},tag=megaphone] animation.cursed_speech.die_mg
...
execute as @s[scores={move=35},tag=!megaphone] at @s positioned ^^1^7.05 run function speech/die
execute as @s[scores={move=35},tag=!megaphone] at @s positioned ^^1^14.05 run function speech/die
execute as @s[scores={move=35},tag=!megaphone] at @s positioned ^^1^21.05 run function speech/die

execute as @s[scores={move=35},tag=megaphone] at @s positioned ^^1^25 run function speech/die_mg
