...
playanimation @s[scores={move=50..51},tag=!megaphone] animation.cursed_speech.sleep
playanimation @s[scores={move=50..51},tag=megaphone] animation.cursed_speech.sleep_mg
event entity @s[scores={move=3..},has_property={property:heart=!5},tag=megaphone,type=player] megaphone_on


scoreboard players add @s[scores={move=50}] speech 8
execute as @s[scores={move=49}] run function speech/speech_limit
...
execute as @s[scores={move=35}] at @s anchored eyes run particle ds:sleep ^1.5^^
...
execute as @s[scores={move=35}] at @s positioned ^^1^1 run camerashake add @a[r=25] 0.15 0.45
execute as @s[scores={move=35}] at @s positioned ^^1^1 run playsound mob.speech_sleep @a[r=100] ~~~ 99999 1 99999
execute as @s[scores={move=35}] at @s positioned ^^1^1 run playsound mob.cursed_tune @a[r=100] ~~~ 99999 0.7 99999
...
execute as @s[scores={move=15},tag=!megaphone] at @s positioned ^^1^7.05 run function speech/sleep
execute as @s[scores={move=15},tag=!megaphone] at @s positioned ^^1^14.05 run function speech/sleep

execute as @s[scores={move=15},tag=megaphone] at @s positioned ^^1^25 run function speech/sleep_mg
...
tag @s[scores={move=0..1},tag=form4] remove form4