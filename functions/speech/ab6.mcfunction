...
execute as @s[scores={move=16},tag=!megaphone] at @s positioned ^^1^7.05 run function speech/break
execute as @s[scores={move=16},tag=!megaphone] at @s positioned ^^1^14.05 run function speech/break
...
execute as @s[scores={move=16},tag=megaphone] at @s positioned ^^1^25 run function speech/break_mg
