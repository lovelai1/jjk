scoreboard players operation @s[scores={move=25..},tag=cursed_speech] speech_limit = @s EnergyCap
scoreboard players operation @s[scores={move=25..},tag=cursed_speech] speech_limit += @s endurance
scoreboard players operation @s[scores={move=25..},tag=cursed_speech] speech_limit /= ten endurance
tag @s[scores={move=25..26},hasitem={item=ds:megaphone,location=slot.hotbar},type=player,tag=!megaphone] add megaphone
tag @s[scores={move=25..26},hasitem={item=ds:megaphone,location=slot.weapon.mainhand},type=!player,tag=!megaphone] add megaphone
playanimation @s[scores={move=25..26},tag=!megaphone] animation.cursed_speech.break
playanimation @s[scores={move=25..26},tag=megaphone] animation.cursed_speech.break_mg
event entity @s[scores={move=3..},has_property={property:heart=!5},tag=megaphone,type=player] megaphone_on


scoreboard players add @s[scores={move=25}] speech 20
...
execute as @s[scores={move=25}] at @s anchored eyes run particle ds:get ^-1.5^^
execute as @s[scores={move=16}] at @s anchored eyes run particle ds:crushed ^-1.5^^
...
execute as @s[scores={move=25}] at @s positioned ^^1^1 run playsound mob.speech_getcrushed @a[r=100] ~~~ 99999 1 99999
...
execute as @s[scores={move=16},tag=!megaphone] at @s positioned ^^1^7.05 run function speech/get_crushed
execute as @s[scores={move=16},tag=!megaphone] at @s positioned ^^1^14.05 run function speech/get_crushed
execute as @s[scores={move=3..16},tag=!megaphone] at @s positioned ^^1^7.05 as @e[scores={Stun=3..},tag=!Frames,tag=!speech_adapted,r=6.99,type=!item,family=!projectile,family=!despawncito,family=!damage,family=!disappear,type=!xp_orb,type=!arrow,type=!thrown_trident,type=!fireball,type=!dragon_fireball,type=!small_fireball,type=!fireworks_rocket,type=!fishing_hook,type=!splash_potion,type=!area_effect_cloud,type=!snowball,type=!egg,type=!falling_block,tag=!unselect,type=!ds:lapse_explode,type=!ds:red_reversal,type=!ds:hollow_nuke,type=!ds:limitless_explosion,type=!ds:pressure,type=!ds:energy_explosion,type=!ds:massive_bomb,type=!ds:shrine_dmg,type=!ds:pachinko_impact1,type=!ds:bolt_explode,type=!ds:shikigami_impact,type=!ds:oxrushex,type=!gg:impact_frame,type=!armor_stand] at @s run particle ds:not_moving
execute as @s[scores={move=3..16},tag=!megaphone] at @s positioned ^^1^14.05 as @e[scores={Stun=3..},tag=!Frames,tag=!speech_adapted,r=6.99,type=!item,family=!projectile,family=!despawncito,family=!damage,family=!disappear,type=!xp_orb,type=!arrow,type=!thrown_trident,type=!fireball,type=!dragon_fireball,type=!small_fireball,type=!fireworks_rocket,type=!fishing_hook,type=!splash_potion,type=!area_effect_cloud,type=!snowball,type=!egg,type=!falling_block,tag=!unselect,type=!ds:lapse_explode,type=!ds:red_reversal,type=!ds:hollow_nuke,type=!ds:limitless_explosion,type=!ds:pressure,type=!ds:energy_explosion,type=!ds:massive_bomb,type=!ds:shrine_dmg,type=!ds:pachinko_impact1,type=!ds:bolt_explode,type=!ds:shikigami_impact,type=!ds:oxrushex,type=!gg:impact_frame,type=!armor_stand] at @s run particle ds:not_moving

execute as @s[scores={move=16},tag=megaphone] at @s positioned ^^1^25 run function speech/get_crushed_mg
execute as @s[scores={move=3..16},tag=megaphone] at @s positioned ^^1^25 as @e[scores={Stun=3..},tag=!Frames,tag=!speech_adapted,r=24.9,type=!item,family=!projectile,family=!despawncito,family=!damage,family=!disappear,type=!xp_orb,type=!arrow,type=!thrown_trident,type=!fireball,type=!dragon_fireball,type=!small_fireball,type=!fireworks_rocket,type=!fishing_hook,type=!splash_potion,type=!area_effect_cloud,type=!snowball,type=!egg,type=!falling_block,tag=!unselect,type=!ds:lapse_explode,type=!ds:red_reversal,type=!ds:hollow_nuke,type=!ds:limitless_explosion,type=!ds:pressure,type=!ds:energy_explosion,type=!ds:massive_bomb,type=!ds:shrine_dmg,type=!ds:pachinko_impact1,type=!ds:bolt_explode,type=!ds:shikigami_impact,type=!ds:oxrushex,type=!gg:impact_frame,type=!armor_stand] at @s run particle ds:not_moving
...
tag @s[scores={move=0..1},tag=form8] remove form8