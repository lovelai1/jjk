...
scoreboard players add @s[scores={move=70}] speech 20
...
execute as @s[scores={move=42}] at @s anchored eyes run particle ds:plummet ^1.33^-1^
execute as @s[scores={move=42}] at @s anchored eyes run particle ds:plummet ^-1.33^-1^
...
execute as @s[scores={move=52}] at @s positioned ^^1^1 run camerashake add @a[r=25] 0.15 0.45
execute as @s[scores={move=52}] at @s positioned ^^1^1 run playsound mob.speech_plummet @a[r=100] ~~~ 99999 1 99999
execute as @s[scores={move=40}] at @s positioned ^^1^1 run playsound mob.cursed_tune @a[r=100] ~~~ 99999 0.5 99999
...
execute as @s[scores={move=33},tag=!megaphone] at @s positioned ^^1^7.05 run function speech/plummet
execute as @s[scores={move=33},tag=!megaphone] at @s positioned ^^1^14.05 run function speech/plummet

execute as @s[scores={move=33},tag=megaphone] at @s positioned ^^1^25 run function speech/plummet_mg
...
tag @s[scores={move=0..1},tag=form9] remove form9