...
execute as @s[scores={Deleter=31..,Evade=0..}] at @s run camerashake add @a[tag=!fuga_use,r=200] 0.12 0.066 rotational

particle ds:incomplete_shrine_aura1 ~~7~
particle ds:incomplete_shrine_aura2 ~~7~

execute as @s[scores={Deleter=31..,Evade=0..}] at @s unless entity @e[tag=fuga_use,scores={move=2000..2750},r=250]  run particle ds:malevolent_slash_marks1 ~~~
execute as @s[scores={Deleter=31..,Evade=125}] at @s unless entity @e[tag=fuga_use,scores={move=2000..2750},r=250]  run particle ds:incomplete_shrine_slashes1 ~~1~
execute as @s[scores={Deleter=31..}] at @s unless entity @e[tag=fuga_use,scores={move=2000..2750},r=250]  run particle ds:incomplete_shrine_slashes5 ~~-3~
execute as @s[scores={Deleter=31..}] at @s unless entity @e[tag=fuga_use,scores={move=2000..2750},r=250]  run particle ds:incomplete_shrine_slashes6 ~~-3~
...
execute as @s[scores={Deleter=31..,Evade=0..}] at @s unless entity @e[tag=fuga_use,tag=domainactive,r=250] run particle ds:incomplete_shrine_slashes1 ~~1~
...
execute unless entity @s[scores={EnergyCap=0..}] run scoreboard players add @s EnergyCap 0
...
execute as @s[scores={Evade=0..,EnergyCap=0}] at @s if entity @e[tag=griefable,c=1]  run execute as @e[type=ds:shrine_dmg,c=1] at @s if entity @e[type=ds:incomplete_shrine,r=33] run kill @s
...
scoreboard players random @s[scores={Energy=0}] Energy 1 5

scoreboard players remove @s[scores={Evade=1..}] Evade 1
scoreboard players set @s[scores={Evade=0}] Evade 150

execute as @s[scores={Evade=5..}] at @s run fill ~7~-3~7 ~-7~~-7 barrier [] replace air
execute as @s[scores={Evade=5..}] at @s run fill ~3~14~3 ~-3~~-3 barrier [] replace air
execute as @s[scores={Evade=5..}] at @s run fill ~~~ ~~1~ air [] replace barrier
execute as @s[scores={Evade=5..}] at @s run execute as @e[r=15,type=!ds:incomplete_shrine] at @s if block ~~~ barrier run tp @s ~~1~
