...
execute as @s[type=ds:wcs] run particle ds:world_slash
execute as @s[type=ds:wcs2] if entity @e[tag=griefable] run fill ~3~25 ~3 ~-3 ~-25 ~-3 air
execute as @s[type=ds:wcs2] if entity @e[tag=griefable] run fill ~1 ~35 ~1 ~-1 ~35 ~-1 air
